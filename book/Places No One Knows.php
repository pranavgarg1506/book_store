...
<div class="div1">
    <div class="block">
	<img src="u1.jpg" alt="Mountain View" style="width:350px;height:480px;">
...
<div class="div2">
     <h2> PLACES NO ONE KNOWS </h2> <h3> ( English, Brenna Yovanoff ) </h3><p>
	 Waverly Camdenmar spends her nights running until she can’t even think. Then the sun comes up, life goes on, and Waverly goes back to her perfectly hateful best friend, her perfectly dull classes, and the tiny, nagging suspicion that there’s more to life than student council and GPAs.</p>
                <p><h3> <span style="color:#800000">Rs.200&nbsp; </span><strike><span style="color:cd8f3f">Rs.250</span></strike></h3></p>
				<h4>You Save:&nbsp;<span style="color:#800000">Rs.50(20%)</span></h4>
				<h4><span style="color:#800000">Author</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:#cd8f3f"> Brenna Yovanoff</span></h4>
				Pages:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;180
</div>
