...
<div class="div1">
    <div class="block">
	<img src="harry4.jpg" alt="Mountain View" style="width:350px;height:480px;">
...
<div class="div2">
     <h2> Harry Potter and the Goblet of Fire </h2> <h3> ( English, J. K. Rowling  ) </h3><p>
	 Harry starts his fourth year at Hogwarts, and yet again, he and his friends invite a danger so wicked, that it finally dawns on Harry why He Who Must Not Be Named is actually dreaded.</p>
                <p><h3> <span style="color:#800000">Rs.424&nbsp; </span><strike><span style="color:cd8f3f">Rs.699</span></strike></h3></p>
				<h4>You Save:&nbsp;<span style="color:#800000">Rs.275(39%)</span></h4>
