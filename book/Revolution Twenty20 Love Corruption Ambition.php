...
<div class="div1">
    <div class="block">
	<img src="c4.jpg" alt="Mountain View" style="width:350px;height:480px;">
...
<div class="div2">
     <h2> Revolution Twenty20 Love Corruption Ambition </h2> <h3> ( English, Chetan Bhagat) </h3><p>
	 The Deathly Hallows is the final instalment of J.K. Rowling's bestselling series, Harry Potter. This title has Harry and his friends reeling after the death of the world's greatest wizard, Albus Dumbledore.</p>
                <p><h3> <span style="color:#800000">Rs.426&nbsp; </span><strike><span style="color:cd8f3f">Rs.699</span></strike></h3></p>
				<h4>You Save:&nbsp;<span style="color:#800000">Rs.273(39%)</span></h4>
