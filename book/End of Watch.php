...
<div class="div1">
    <div class="block">
	<img src="l2.jpg" alt="Mountain View" style="width:350px;height:480px;">
...
<div class="div2">
     <h2> End of Watch </h2> <h3> ( English, 	Stephen King  ) </h3><p>
	 Waverly Camdenmar spends her nights running until she can’t even think. Then the sun comes up, life goes on, and Waverly goes back to her perfectly hateful best friend, her perfectly dull classes, and the tiny, nagging suspicion that there’s more to life than student council and GPAs.</p>
                <p><h3> <span style="color:#800000">Rs.559&nbsp; </span><strike><span style="color:cd8f3f">Rs.799</span></strike></h3></p>
				<h4>You Save:&nbsp;<span style="color:#800000">Rs.240(30%)</span></h4>
				<h4><span style="color:#800000">Author</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:#cd8f3f"> 	Stephen King </span></h4>
				Pages:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;680
</div>
