...
<div class="div1">
    <div class="block">
	<img src="b6.jpg" alt="Mountain View" style="width:350px;height:480px;">
...
<div class="div2">
     <h2> The Monk Who Sold His Ferrari </h2> <h3> ( English, Robin Sharma  ) </h3><p>
	Readers can read the subtitle of The Monk Who Sold His Ferrari and learn that the book is “a fable about fulfilling your dreams and reaching your destiny”. The story is about Julian Mantle, a lawyer, who sets out on a spiritual journey to find peace and meaning in life.</p>
                <p><h3> <span style="color:#800000">Rs.250&nbsp; </span><strike><span style="color:cd8f3f">Rs.300</span></strike></h3></p>
				<h4>You Save:&nbsp;<span style="color:#800000">Rs.50(16%)</span></h4>
				<h4><span style="color:#800000">Author</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:#cd8f3f"> Robin Sharma </span></h4>
				Pages:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;267
</div>
