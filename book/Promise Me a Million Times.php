...
<div class="div1">
    <div class="block">
	<img src="l1.jpg" alt="Mountain View" style="width:350px;height:480px;">
...
<div class="div2">
     <h2> Promise Me a Million Times </h2> <h3> ( English, Keshav Anee  ) </h3><p>
	 Waverly Camdenmar spends her nights running until she can’t even think. Then the sun comes up, life goes on, and Waverly goes back to her perfectly hateful best friend, her perfectly dull classes, and the tiny, nagging suspicion that there’s more to life than student council and GPAs.</p>
                <p><h3> <span style="color:#800000">Rs.87&nbsp; </span><strike><span style="color:cd8f3f">Rs.175</span></strike></h3></p>
				<h4>You Save:&nbsp;<span style="color:#800000">Rs.88(50%)</span></h4>
				<h4><span style="color:#800000">Author</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:#cd8f3f"> Keshav Anee </span></h4>
				Pages:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;280
</div>
