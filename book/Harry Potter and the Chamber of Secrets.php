...
<div class="div1">
    <div class="block">
	<img src="harry2.jpg" alt="Mountain View" style="width:350px;height:480px;">
...
<div class="div2">
     <h2> Harry Potter and the Chamber of Secrets </h2> <h3> ( English, J. K. Rowling  ) </h3><p>
	 Harry Potter returns to his second year at Hogwarts, only to discover that someone has opened the dangerous Chamber of Secrets. Can Harry and his friends escape the terror that lurks within? Find out in J. K. Rowling’s amazing second book, Harry Potter and the Chamber of Secrets!</p>
                <p><h3> <span style="color:#800000">Rs.716&nbsp; </span><strike><span style="color:cd8f3f">Rs.843</span></strike></h3></p>
				<h4>You Save:&nbsp;<span style="color:#800000">Rs.127(15%)</span></h4>
