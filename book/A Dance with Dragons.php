...
<div class="div1">
    <div class="block">
	<img src="got5.jpeg" alt="Mountain View" style="width:350px;height:480px;">
...
<div class="div2">
     <h2> A Dance with Dragons </h2> <h3> ( English, George R. R. Martin  ) </h3><p>
	The future of the Seven Kingdoms hangs in the balance.
In the east, Daenerys, last scion of House Targaryen, her dragons grown to terrifying maturity, rules as queen of a city built on dust and death, beset by enemies.
Now that her whereabouts are known many are seeking Daenerys and her dragons. Among them the dwarf, Tyrion Lannister, who has escaped King′s Landing with a price on his head, wrongfully condemned to death for the murder of his nephew, King Joffrey. But not before killing his hated father, Lord Tywin.</p>
                <p><h3> <span style="color:#800000">Rs.385&nbsp; </span><strike><span style="color:cd8f3f">Rs.550</span></strike></h3></p>
				<h4>You Save:&nbsp;<span style="color:#800000">Rs.165(30%)</span></h4>
				<h4><span style="color:#800000">Author</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:#cd8f3f"> George R. R. Martin </span></h4>
				Pages:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;720
</div>
