...
<div class="div1">
    <div class="block">
	<img src="got2.jpeg" alt="Mountain View" style="width:350px;height:480px;">
...
<div class="div2">
     <h2> A Clash of Kings </h2> <h3> ( English, George R. R. Martin  ) </h3><p>
	 Waverly Camdenmar spends her nights running until she can’t even think. Then the sun comes up, life goes on, and Waverly goes back to her perfectly hateful best friend, her perfectly dull classes, and the tiny, nagging suspicion that there’s more to life than student council and GPAs.</p>
                <p><h3> <span style="color:#800000">Rs.440&nbsp; </span><strike><span style="color:cd8f3f">Rs.550</span></strike></h3></p>
				<h4>You Save:&nbsp;<span style="color:#800000">Rs.110(20%)</span></h4>
