...
<div class="div1">
    <div class="block">
	<img src="c3.jpg" alt="Mountain View" style="width:350px;height:480px;">
...
<div class="div2">
     <h2> The 3 Mistakes of My Life </h2> <h3> ( English, Chetan Bhagat  ) </h3><p>
	The 3 Mistakes Of My Life revolves around Govind, Omi, and Ishaan. Although they have different personalities, their love for cricket unites them. They decide to start a shop that sells cricket-related items. Omi’s father is a priest at the temple, and has a great deal of influence there.</p>
                <p><h3> <span style="color:#800000">Rs.120&nbsp; </span><strike><span style="color:cd8f3f">Rs.176</span></strike></h3></p>
				<h4>You Save:&nbsp;<span style="color:#800000">Rs.56(31%)</span></h4>
